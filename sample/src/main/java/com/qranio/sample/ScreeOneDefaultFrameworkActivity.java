...
public class ScreeOneDefaultFrameworkActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_screen_one_default_framework);
        setScreenComponents();
